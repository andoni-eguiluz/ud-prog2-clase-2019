...
/** Ejemplo de invocación a Swing para hacer las tareas de GUI
 * y la relevancia de que toda construcción de componentes la haga el propio Swing
...
public class EjemploInvoke extends JFrame implements ActionListener
{
	...
	public EjemploInvoke()
	{
		...
		// (pero si este código lo ejecuta el hilo de Swing entonces no hay problema)
		setVisible(true);
