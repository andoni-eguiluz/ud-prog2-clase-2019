...
/** Ejemplo de animación de un JLabel en una ventana con escuchadores en clases externas
...
public class EjemploAnimacionBalonJLabel extends JFrame {
	...
	public EjemploAnimacionBalonJLabel() {
		...
		lBalon = new JLabel( new ImageIcon( getClass().getResource("/img/balon.png") ) );
		pFondo = new JPanel();
