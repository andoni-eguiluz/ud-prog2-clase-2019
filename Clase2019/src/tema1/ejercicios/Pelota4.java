...
public class Pelota4 {
	...
	public static void main(String[] args) {
		...
		Pelota4 p1 = new Pelota4( 200, 300, 300, 'a' );
		p1.bota = true;
	...
	private static void dibujaYBorra( VentanaGrafica v, Pelota4 r ) {
		r.dibuja( v );
		v.espera( 1000 );
		r.borra( v );
	}
	...
	private static void dibujaYCrece( VentanaGrafica v, Pelota4 p, double nuevoRadio ) {
	...
	public Pelota4( double radio, double x, double y, char color ) {
		this.radio = radio;
		this.x = x;
		this.y = y;
		this.color = color;
...
//	}
	...
	public boolean equals(Object obj) {
		Pelota4 p2 = (Pelota4) obj;  // Cast de obj a Pelota2 (lo entenderemos mejor al ver herencia)
