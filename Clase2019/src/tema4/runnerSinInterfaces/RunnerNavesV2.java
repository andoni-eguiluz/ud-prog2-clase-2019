package tema4.runnerSinInterfaces;
...
public class RunnerNavesV2 {
	...
	public static void main(String[] args) {
		RunnerNavesV2 juego = new RunnerNavesV2();
		juego.jugar();
	}
	...
	private void crearFondos() {
		...
		Fondo fondo2 = new Fondo( "/img/UD-roller.jpg", 1000, 333, 1.0, 0.35f, 1000 );
