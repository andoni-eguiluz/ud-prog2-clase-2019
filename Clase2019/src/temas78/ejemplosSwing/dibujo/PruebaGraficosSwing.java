 ...
 */
public class PruebaGraficosSwing {
	...
	public static void main(String[] args) {
		...
		URL recursoImgURL = PruebaGraficosSwing.class.getResource( "/img/bicho.png" );  // Path desde la clase
		JPanel panelFondo1 = new JPanelFondo( recursoImgURL );
		File ficheroImg = new File( "bin/img/coches/coche.png" );  // Path de fichero desde el proyecto
