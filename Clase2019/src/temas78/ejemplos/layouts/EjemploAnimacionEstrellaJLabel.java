package temas78.ejemplos.layouts;
...
import temas78.utils.JLabelGraficoAjustado;

/** Ejemplo de animación de JLabel en ventana con escuchadores en clases internas
...
public class EjemploAnimacionEstrellaJLabel extends JFrame {
	...
	public EjemploAnimacionEstrellaJLabel() {
		...
		lEstrella = new JLabelGraficoAjustado( "/img/star.png", 200, 200 );
