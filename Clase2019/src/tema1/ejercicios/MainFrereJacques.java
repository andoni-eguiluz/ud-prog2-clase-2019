...
//		/* Opción acompañamiento (acordes)
		// Crear acompañamiento
		Acompanyamiento acomp = new Acompanyamiento( "Frere Jacques - acordes" );
		acomp.setTempo( 2.0 );
		...
		acomp.transponer( -7 );  // El acompañamiento está en sol y la melodía en do (disminuimos 7 el acompañamiento)
		System.out.println( "Acompañamiento: " + acomp );
		acomp.setVolumen( 0.3 );
//		 */
